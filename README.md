...
An internet connection is needed for the Google Fonts Inter typeface and the original CloudFront background video and poster image. Those assets remain hosted at the URLs supplied in the specification.

This is a visual template. The brand and CTA links use `#` placeholders; the navigation labels and play icon are presentational, as specified.
